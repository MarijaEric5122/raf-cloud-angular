...
public class MachineScheduleController {
    ...
    // DTO koji šaljemo frontu (bez LAZY problema)
    public static class MachineScheduleRowDto {
        public Long id;
        public Long machineId;
        public String operation;     // START/STOP/RESTART
        public LocalDateTime runAt;
        public String status;        // PENDING/DONE/FAILED
        public String errorMessage;  // može null
        public Long createdById;     // ko je zakazao
    }
    ...
    public List<MachineScheduleRowDto> getSchedules() {
        ...
        return scheduleService.getSchedulesForUser(current, isAdmin)
                ...
                .map(s -> {
                    ...
                    dto.errorMessage = s.getErrorMessage(); // ako postoji u entitetu
